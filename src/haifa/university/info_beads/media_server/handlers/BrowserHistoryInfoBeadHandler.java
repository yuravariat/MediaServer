...
/**
 * BrowserHistoryInfoBeadHandler
 * @author Yuri Variat
 * @version  1.0;
 *
 */
public class BrowserHistoryInfoBeadHandler extends InfoBead<ArrayList<Triplet<HistoryBookmark>>> implements Runnable {
	private static final String TAG="BrowserHistoryInfoBeadHandler";
	private static final long serialVersionUID = 1L;
	private File applicationDir = new File(Paths.get(".").toAbsolutePath().normalize().toString(), "MediaAgent");
	private final String SETTINGS_FILE_NAME = "BrowserHistoryInfoBeadHandler.txt";
	private boolean debugMode = true;

    private volatile boolean running = false;
    private volatile boolean started = false;

    public BrowserHistoryInfoBeadHandler(){
        super();
        initialize();
    }
	...
	{
		// -------------- set id ------------------------
		this.setInfoBeadId("BrowserHistoryInfoBeadHandler");
		...
		metadata.setInfoBeadName("BrowserHistoryInfoBeadHandler");
	...
	public void handleData(Triplet<ArrayList<Triplet<HistoryBookmark>>> inTriplet) 
	{
		ArrayList<Triplet<HistoryBookmark>> collection = inTriplet.getInfoItem().getInfoValue();
	}
	public void pushData(Triplet<ArrayList<Triplet<HistoryBookmark>>> tripletToDeliver) {
